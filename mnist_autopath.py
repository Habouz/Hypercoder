...
if __name__ == "__main__":
    ...
    for epoch in range(10):
        ...
        for batch, _ in loader:
            ...
            weight_list = [layer.weight for layer in linear_layers[1:5]]
            bias_list = [layer.bias for layer in linear_layers[1:5]]

            #REVIEW: Check seperately if it gives the desired outputs
            eloss, paths = path_entropy_parallel(32, 32, weight_list = weight_list, bias_list = bias_list, a = 0.5, paths = paths)
    ...
    # === Save ===
    torch.save(encoder, "mnist_path_encoder_full.pth")
    torch.save(decoder, "mnist_path_decoder_full.pth")